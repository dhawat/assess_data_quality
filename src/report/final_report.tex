...
\subsection{Redundancy metric, duplication test} % (fold)
...
\subsection{Accuracy metric, typographic test} % (fold)
...
In this section we examine only categorical columns.
...
We finally get the clustered data and apply the same technique as used in \ref{sub:Affinity propagation algorithm} to identify misspelled words.
